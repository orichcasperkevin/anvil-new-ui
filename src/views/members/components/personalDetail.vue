<template>
    <div class="memberdetail" >    
            ...
            <div class="row bg-white shadow-sm rounded" style="padding: 25px 25px 25px 25px">
            <div class="col">
                    <!-- personal detail -->
                    <div class="card border-0 shadow-sm rounded" style="max-width: 18rem;">                            
                            ...
                            <div class="card-body">
                                <span v-for = "(data,index) in member_info" :key="index">
                                <span v-for = "(data,index) in data" :key="index">
                                ...
                                <span v-for = "(data,index) in marital_status_info" :key="index">
                                        <span v-for = "(data,index) in data" :key="index">
                                ...
                                <span v-for = "(data,index) in age_info" :key="index">
                                        <p><b>age :</b> {{data.age}}  <small class="text-info">({{data.d_o_b}})</small></p>
                                </span>
                            </div>
                    </div>
                    <!-- residence data -->
                    <div class="mt-3 card border-0 shadow-sm rounded" style="max-width: 18rem;">
                            <div class="card-header border-0">
                                    <span class="row">
                            ...
                            <p v-if = "residence_info.residence.length == 0 "> none given </p>
                                    <span v-for = "(data,index) in residence_info" :key="index">
                                    <span v-for = "(data,index) in data" :key="index">
            ...
            <div class="col">
                    ...
                    <div class="card border-0 shadow-sm rounded" style="max-width: 18rem;">
                            ...
                            <div class="card-body" v-if="contact_info">
                                    ...
                                    <span v-for = "(data,index) in contact_info" :key="index">
                                            <span v-for = "(data,index) in data" :key="index">
