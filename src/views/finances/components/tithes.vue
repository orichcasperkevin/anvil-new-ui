            ...
            <div v-if="! hide_content">
                ...
                <content>          
                    ...
                    <table class="mt-5 table table-responsive-sm table-borderless">
                        ...
                        <tbody >
                            <tr v-for = "(data,index) in tithes.response" :key="index">                                
                                <td>                                          
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">                                 
                                ...
                                <div v-if="add_tithe_errors.length > 0">
                                    <ul>
                                            <small>
                                                <li v-for="(error,index) in add_tithe_errors" :key="index">
                                ...
                                <form>                                                                                                                           
                                        ...
                                        <div v-if="tithe_amount_error.length > 0">
                                            <ul>
                                                <small>
                                                    <li v-for="(error,index)  in tithe_amount_error" :key="index">
                                                        <p class="text-danger">{{ error }}</p>
                                                    </li>
                                                </small>
                                            </ul>
