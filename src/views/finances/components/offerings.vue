        ...
        <div v-if="offerings && offering_stats">            
            ...
            <div v-if="! hide_content">
                ...
                <table class="mt-4 table table-responsive-sm table-borderless">
                    ...
                    <tbody>
                        <tr v-for = "(data,index) in offerings.response" :key="index">                             
                            <td>                                          
                        ...
                        <div class="modal-body">                                                            
                                <form>                                        
                                        ...
                                        <p v-if="selected_member_errors.length">
                                            <ul>
                                                <small>
                                                    <li v-for="(error,index) in selected_member_errors" :key="index">
                                        ...
                                        <p v-if="service_type_errors.length">
                                            <ul>
                                                <small>
                                                    <li v-for="(error,index) in service_type_errors" :key="index">
                                                        <p class="text-danger">{{ error }}</p>
                                                    </li></small>
                                            </ul>
                                        </p>                                                                                                                                                                              
                                        ...
                                        <div class="row form-group">
                                                ...
                                                <p v-if="offering_amount_errors.length">
                                                    <ul>
                                                        <small>
                                                            <li v-for="(error,index) in offering_amount_errors" :key="index">
                                                                <p class="text-danger">{{ error }}</p>
                                                            </li>
                                                        </small>
                                                    </ul>
                                        ...
                                        <div class="row">                                                        
                                            ...
                                            <select class="col-5 form-control custom-select"
                                                    ...
                                                    <option v-for= "(method,index) in payment_methods" :key="index"
                                                         :value="method.id" >
                                                         {{method.name}}
                                                    </option>                                                    
                                            </select>                                                                                                                                                       
                                        ...
                                        <div class="form-group">
                                                <div class="row" v-if="show_date">                                                    
                                                    ...
                                                    <p v-if="offering_date_errors.length">
                                                        <ul>
                                                            <small><li v-for="(error,index) in offering_date_errors" :key="index"><p class="text-danger">{{ error }}</p></li></small>
                                                        </ul>
                                                    </p>
                                                </div>
                                        </div>
        ...
        methods: {
            ...
            if (!version || version < currentVersion){
                ...
                .then(response => {                                       
                    ...
                    if (this.offering_type){
                        var offering_type_id = this.offering_type.id                                           
                        response = this.offerings.response
                        this.offerings.response = response.filter(function(offering){
                            return offering.type == offering_type_id
                        })
                    }
