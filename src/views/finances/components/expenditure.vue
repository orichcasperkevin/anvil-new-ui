    ...
    <div>  
        ...
        <div>
            ...
            <table class="mt-4 table table-responsive-sm table-borderless">
                ...
                <tbody>
                    <tr v-for = "(data,index) in expenditure_types.response" :key="index">                                           
                        <td>
                            ...
                            <form>                                            
                                    <div class="row form-group">
                                            ...
                                            <p v-if="expenditure_type_name_errors.length">
                                                <ul>
                                                        <small><li v-for="(error,index) in expenditure_type_name_errors" :key="index"><p class="text-danger">{{ error }}</p></li></small>
                                                </ul>
                                            </p>
                                    </div>                                    
                                    <hr/>   
