                       ...
                       <!-- ENVELOPES -->
                        <div class="tab-pane fade show active" id="v-pills-envelopes" role="tabpanel" aria-labelledby="v-pills-envelopes-tab">
                            ...
                            <div class="tab-content" id="pills-tabContent">   
                                ...
                                <!-- Offerings-->
                                <div v-for="(type,index) in offering_types" :key="index"  
                                    class="tab-pane fade" 
                            ...
                            <div>
                                <div v-if="any_other_selected">
                                    ...
                                    <table class="mt-4 table table-responsive-sm table-borderless">
                                        ...
                                        <tbody>
                                            <tr v-for = "(data,index) in incomes.response" :key="index">
                                                <td>
                         ...
                         v-if = "(tithes_selected || offerings_selected)">
                            ...
                            <div class="dropdown-menu border-success text-capitalize" 
                                ...
                                <a class="dropdown-item d-flex justify-content-between"  
                                    v-for="(type,index) in offering_types" :key="index"
                                    href="#" data-toggle="modal" 
                                ...
                                <form>                                            
                                        <div class=" row form-group">
                                            ...
                                            <select class="col-8 form-control" v-model="income_type" >
                                                <option v-for="(data,index) in income_types.response" :key="index" :value="data.id" >{{data.type_name}}</option>
                                            </select>   
                                            <p v-if="income_type_errors.length">
                                                <ul>
                                                        <small><li v-for="(error,index) in income_type_errors" :key="index"><p class="text-danger">{{ error }}</p></li></small>
                                                </ul>
                                            </p>                                       
                                        </div>                                                                                
                                        <hr/>
                                        <div class="row form-group">
                                                ...
                                                <p v-if="income_amount_errors.length">
                                                    <ul>
                                                            <small><li v-for="(error,index) in income_amount_errors" :key="index"><p class="text-danger">{{ error }}</p></li></small>
                                                    </ul>
                                                </p> 
                                        </div>
                                        <hr/>   
                            ...
                            <form>                                            
                                    <div class="row form-group">
                                            ...
                                            <p v-if="income_type_name_errors.length">
                                                <ul>
                                                        <small><li v-for="(error,index) in income_type_name_errors" :key="index"><p class="text-danger">{{ error }}</p></li></small>
                                                </ul>
                                            </p>
                                    </div>                                    
                                    <hr/>   
...
<script>
import expenditures from './components/expenditure.vue'
import all from './components/all.vue'
import tithes from './components/tithes.vue'
import offerings from './components/offerings.vue'
import importFromCSV from './components/importFromCSV.vue'
